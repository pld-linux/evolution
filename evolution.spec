...
# Source0-md5:	c7aa347eb188d53b22941129d9300fb4
...
Requires:	evolution-data-server >= 1.7.91
...
Requires:	evolution-data-server-devel >= 1.7.91
Requires:	freetype-devel
Requires:	gnome-vfs2-devel >= 2.15.91
Requires:	gtkhtml-devel >= 3.11.91
