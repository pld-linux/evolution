...
Source0:	http://ftp.gnome.org/pub/GNOME/sources/evolution/2.29/%{name}-%{version}.tar.bz2
# Source0-md5:	069125b198c195fb6d090ae3581e8c0a
...
BuildRequires:	evolution-data-server-devel >= 2.29.92
...
BuildRequires:	gtkhtml-devel >= 3.29.92
...
Requires:	evolution-data-server >= 2.29.92
Requires:	gtkhtml >= 3.29.92
Requires:	psmisc
...
Requires:	evolution-data-server-devel >= 2.29.92
Requires:	glib2-devel >= 1:2.22.0
Requires:	gnome-desktop-devel >= 2.28.0
Requires:	gtk+2-devel >= 2:2.18.0
Requires:	gtkhtml-devel >= 3.29.92
