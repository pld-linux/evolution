...
# Source0-md5:	3ddcefdcbcb04055393c547992c2f3da
...
BuildRequires:	evolution-data-server-devel >= 2.28.3.1
...
BuildRequires:	gtkhtml-devel >= 3.28.3
...
Requires:	evolution-data-server >= 2.28.3.1
Requires:	gtkhtml >= 3.28.3
Requires:	psmisc
...
Requires:	evolution-data-server-devel >= 2.28.3.1
Requires:	glib2-devel >= 1:2.20.0
Requires:	gtk+2-devel >= 2:2.16.0
Requires:	gtkhtml-devel >= 3.28.3
...
%attr(755,root,root) %{_libdir}/evolution/%{basever}/libevolution-cal-shared.so.*
...
%{_libdir}/evolution/%{basever}/libevolution-cal-shared.la
...
%{_libdir}/evolution/%{basever}/libevolution-cal-shared.a
...
%{_datadir}/evolution/%{basever}/glade/email-custom-header.glade
%{_datadir}/evolution/%{basever}/glade/org-gnome-email-custom-header.glade
...
%{evo_plugins_dir}/templates.glade
